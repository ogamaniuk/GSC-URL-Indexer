...
Chrome extension that bulk-checks and requests indexing for your sitemap URLs through Google Search Console.

Instead of inspecting URLs one by one in GSC, paste your sitemap URL and let it run.
...
2. Paste a sitemap URL (e.g. `https://example.com/sitemap.xml`)
3. Click Start
